...
@allure.feature("订单管理")
class TestOrderInfoManagement:
    """
    订单管理模块测试 - 使用YAML数据驱动
    """
    
    @pytest.mark.parametrize("case_data", get_testcase_yaml("testcase/easyjava_test/order_info.yaml"))
    def test_order_info_api(self, case_data):
        """
        订单管理接口测试
        """
        # 检查数据结构并正确获取测试用例信息
