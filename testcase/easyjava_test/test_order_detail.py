...
@allure.feature("订单详情管理")
class TestOrderDetailManagement:
    """
    订单详情管理模块测试 - 使用YAML数据驱动
    """
    
    @pytest.mark.parametrize("case_data", get_testcase_yaml("testcase/easyjava_test/order_detail.yaml"))
    def test_order_detail_api(self, case_data):
        """
        订单详情管理接口测试
        """
        # 检查数据结构并正确获取测试用例信息
